...
| GitHub Issues | Concrete, actionable backlog: confirmed bugs and scoped feature slices | Before picking up new work on a "finished" app |
| [`ideas.md`](ideas.md) | Brainstormed feature/UX ideas and device-identification technique ideas, ranked by ROI, for work not yet scoped enough to be an issue | When looking for what to build next |
