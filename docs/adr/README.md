...
| [0009](0009-lan-throughput-icmp-burst-estimate.md) | LAN throughput test uses an ICMP echo burst, not a transfer endpoint |
| [0010](0010-hand-rolled-benchmark-harness.md) | Hand-rolled wall-clock benchmark harness, not JMH or kotlinx-benchmark |
