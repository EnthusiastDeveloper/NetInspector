 ...
 * per-host query. Also carries improvement-ideas.md #24's "known device" flag on the same
...
class DefaultSavedHostRepository
    ...
    constructor(
        ...
        // improvement-ideas.md #24 - a row can now exist for the known-device flag alone, with
